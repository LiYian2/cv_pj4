...
export E9_EXPECT_DENSE_MATCH_V1=1
mkdir -p "$HF_HOME" "$HUGGINGFACE_HUB_CACHE" "$TRANSFORMERS_CACHE"
cd /home/bzhang512/CV_Project/third_party/S3PO-GS
exec /home/bzhang512/miniconda3/envs/s3po-gs/bin/python slam.py --config /home/bzhang512/CV_Project/part3_BRPO/configs/e9_dense_match_v1_depthoff.yaml
