...
def parse_args():
    p = argparse.ArgumentParser(description='A1 compare under fixed new T1 topology: old A1 vs new A1 vs BRPO-style A1 v1/v2')
    ...
    p.add_argument('--signal-v2-root', default='/data2/bzhang512/CV_Project/output/part3_BRPO/experiments/20260420_a1_brpo_style_signal_smoke')
...
def main():
    ...
    arms = [
        ...
        {
            'name': 'brpoStyleA1_v1_newT1_summary_only',
            'mode': 'brpo_style_a1_v1',
            'note': 'BRPO-style A1 v1 using hard support-derived C_m and verified projected depth under fixed new T1 topology',
            'extra_args': [
                '--pseudo_observation_mode', 'brpo_style_v1',
            ],
        },
        {
            'name': 'brpoStyleA1_v2_newT1_summary_only',
            'mode': 'brpo_style_a1_v2',
            'note': 'BRPO-style A1 v2 using continuous verifier quality and stabilized target blending under fixed new T1 topology',
            'extra_args': [
    ...
    summary = {
        ...
        'compare_type': 'A1_old_vs_new_vs_brpo_style_v1_v2_under_newT1',
    ...
    if not args.dry_run:
        ...
        brpo_style_v1_arm = summary['arms']['brpoStyleA1_v1_newT1_summary_only']
        brpo_style_v2_arm = summary['arms']['brpoStyleA1_v2_newT1_summary_only']
        summary['delta_new_vs_old'] = {
            'psnr': new_arm['psnr'] - old_arm['psnr'],
            'ssim': new_arm['ssim'] - old_arm['ssim'],
            'lpips': new_arm['lpips'] - old_arm['lpips'],
        }
        summary['delta_brpo_style_v1_vs_old'] = {
            'psnr': brpo_style_v1_arm['psnr'] - old_arm['psnr'],
            'ssim': brpo_style_v1_arm['ssim'] - old_arm['ssim'],
            'lpips': brpo_style_v1_arm['lpips'] - old_arm['lpips'],
        }
        summary['delta_brpo_style_v1_vs_new'] = {
            'psnr': brpo_style_v1_arm['psnr'] - new_arm['psnr'],
            'ssim': brpo_style_v1_arm['ssim'] - new_arm['ssim'],
            'lpips': brpo_style_v1_arm['lpips'] - new_arm['lpips'],
        }
        summary['delta_brpo_style_v2_vs_old'] = {
            'psnr': brpo_style_v2_arm['psnr'] - old_arm['psnr'],
            'ssim': brpo_style_v2_arm['ssim'] - old_arm['ssim'],
            'lpips': brpo_style_v2_arm['lpips'] - old_arm['lpips'],
        }
        summary['delta_brpo_style_v2_vs_new'] = {
            'psnr': brpo_style_v2_arm['psnr'] - new_arm['psnr'],
            'ssim': brpo_style_v2_arm['ssim'] - new_arm['ssim'],
            'lpips': brpo_style_v2_arm['lpips'] - new_arm['lpips'],
        }
        summary['delta_brpo_style_v2_vs_v1'] = {
            'psnr': brpo_style_v2_arm['psnr'] - brpo_style_v1_arm['psnr'],
            'ssim': brpo_style_v2_arm['ssim'] - brpo_style_v1_arm['ssim'],
            'lpips': brpo_style_v2_arm['lpips'] - brpo_style_v1_arm['lpips'],
        }
