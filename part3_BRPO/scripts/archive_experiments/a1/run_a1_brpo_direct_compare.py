...
def parse_args():
    p = argparse.ArgumentParser(description='A1 compare under fixed new T1 topology: old A1 vs new A1 vs BRPO-style v2 vs direct BRPO A1')
...
def main():
    ...
    arms = [
        ...
        {
            'name': 'brpoDirectA1_v1_newT1_summary_only',
            'mode': 'brpo_direct_a1_v1',
            'note': 'Direct BRPO-style A1 using fused-frame reciprocal correspondence C_m and overlap-confidence weighted projected depth under fixed new T1 topology',
            'extra_args': [
    ...
    summary = {
        ...
        'compare_type': 'A1_old_vs_new_vs_brpo_style_v2_vs_direct_brpo_under_newT1',
    ...
    if not args.dry_run:
        ...
        style_v2_arm = summary['arms']['brpoStyleA1_v2_newT1_summary_only']
        direct_arm = summary['arms']['brpoDirectA1_v1_newT1_summary_only']
        ...
        summary['delta_brpo_style_v2_vs_old'] = {
            'psnr': style_v2_arm['psnr'] - old_arm['psnr'],
            'ssim': style_v2_arm['ssim'] - old_arm['ssim'],
            'lpips': style_v2_arm['lpips'] - old_arm['lpips'],
        }
        summary['delta_brpo_direct_vs_old'] = {
            'psnr': direct_arm['psnr'] - old_arm['psnr'],
            'ssim': direct_arm['ssim'] - old_arm['ssim'],
            'lpips': direct_arm['lpips'] - old_arm['lpips'],
        }
        summary['delta_brpo_direct_vs_new'] = {
            'psnr': direct_arm['psnr'] - new_arm['psnr'],
            'ssim': direct_arm['ssim'] - new_arm['ssim'],
            'lpips': direct_arm['lpips'] - new_arm['lpips'],
        }
        summary['delta_brpo_direct_vs_style_v2'] = {
            'psnr': direct_arm['psnr'] - style_v2_arm['psnr'],
            'ssim': direct_arm['ssim'] - style_v2_arm['ssim'],
            'lpips': direct_arm['lpips'] - style_v2_arm['lpips'],
        }
