...
def parse_args():
    p = argparse.ArgumentParser(description='Exact BRPO target-side compare under fixed new T1 topology')
...
def main():
    ...
    arms = [
        ...
        {
            'name': 'exactBrpoFullTarget_v1_newT1_summary_only',
            'mode': 'exact_brpo_full_target_v1',
            'note': 'Full BRPO-style target-side proxy under exact C_m, using shared-C_m depth loss (legacy mode) instead of source-aware target tiers',
            'extra_args': [
    ...
    summary = {
        ...
        'compare_type': 'A1_exact_brpo_target_side_under_newT1',
    ...
    if not args.dry_run:
        ...
        exact_full_arm = summary['arms']['exactBrpoFullTarget_v1_newT1_summary_only']
        ...
        summary['delta_exact_fulltarget_vs_old'] = metric_delta(exact_full_arm, old_arm)
        summary['delta_exact_fulltarget_vs_exact_oldtarget'] = metric_delta(exact_full_arm, exact_old_arm)
        summary['delta_exact_fulltarget_vs_hybrid'] = metric_delta(exact_full_arm, hybrid_arm)
